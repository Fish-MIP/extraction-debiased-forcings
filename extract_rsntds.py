...
for scenario in ['SSP245',  'SSP370',  'SSP585', 'SSP126']:
    ...
    # Output folder
    dirout = os.path.join('/home1/scratch/nbarrier/fishmip-osp/rsntds', scenario.lower())
    dirout
    ...
    filelist = glob(os.path.join(dirin, '*v2_20[2-9]*1m*SBC*'))
    filelist += glob(os.path.join(dirin, '*v2_201[5-9]*1m*SBC*'))
    filelist.sort()
    # print(filelist)
